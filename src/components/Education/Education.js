                  ...
                  <div className={classes.timeline_centered}>
                      ...
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          ...
                          <p>
                            ...
                            <b>Software Developer Engineer</b> at <b>Code IN</b>
                            <i>
                              (previously Montasher and Code IN is a HR
                              technology startup that is building tools and
                              products to simplify recruiting and help
                    ...
                    >
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          <h2>
                            Undergraduation at SLIET <span>2019-2021</span>
                          </h2>
                          <p>
                            I completed my undergraduation in CSE (Computer
                            Science and Engineering) from{" "}
                            <a href="http://sliet.ac.in/">SLIET</a> with overall
                            82.71%.
                          </p>
                        </div>
                      </article>
                    ...
                    >
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          <h2>
                            Higher Education <span>2014-2019</span>
                          </h2>
                          <p>
                    ...
                    >
                      <article>
                        ...
                        <div className={classes.label}>
                          <h2>Internship</h2>
                          <p>
                            Completed Three month Internship in React Js with
